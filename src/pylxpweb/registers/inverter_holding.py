...
INVERTER_HOLDING_REGISTERS: tuple[HoldingRegisterDefinition, ...] = (
    ...
    # =========================================================================
    # DISCHARGE SCHEDULE (regs 74-79)
    # =========================================================================
    HoldingRegisterDefinition(
        address=74,
        canonical_name="discharge_power_command",
        api_param_key="HOLD_DISCHG_POWER_CMD",
        unit="%",
        min_value=0,
        max_value=100,
        category=HoldingCategory.SCHEDULE,
    ...
    HoldingRegisterDefinition(
        address=75,
        canonical_name="discharge_start_hour_1",
        api_param_key="HOLD_DISCHG_START_HOUR_1",
        min_value=0,
        max_value=23,
        category=HoldingCategory.SCHEDULE,
        description="Discharge time period 1 start hour.",
    ),
    HoldingRegisterDefinition(
        address=76,
        canonical_name="discharge_start_minute_1",
        api_param_key="HOLD_DISCHG_START_MINUTE_1",
        min_value=0,
        max_value=59,
        category=HoldingCategory.SCHEDULE,
        description="Discharge time period 1 start minute.",
    ),
    HoldingRegisterDefinition(
        address=77,
        canonical_name="discharge_end_hour_1",
        api_param_key="HOLD_DISCHG_END_HOUR_1",
        min_value=0,
        max_value=23,
        category=HoldingCategory.SCHEDULE,
        description="Discharge time period 1 end hour.",
    ),
    HoldingRegisterDefinition(
        address=78,
        canonical_name="discharge_end_minute_1",
        api_param_key="HOLD_DISCHG_END_MINUTE_1",
        min_value=0,
        max_value=59,
        category=HoldingCategory.SCHEDULE,
        description="Discharge time period 1 end minute.",
    ),
    HoldingRegisterDefinition(
        address=79,
        canonical_name="discharge_enable_period_1",
        api_param_key="HOLD_DISCHG_ENABLE_1",
        min_value=0,
        max_value=1,
        category=HoldingCategory.SCHEDULE,
        description="Discharge time period 1 enable. 0=Off, 1=On.",
    ),
    # =========================================================================
